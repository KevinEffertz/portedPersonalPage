            ...
            <section id="about" className="py-5">
                <div className="container about-Grid">
                    ...
                    <div className="img-selfportrait mr-3 mb-3">
                        <img src={require("./assets/images/DSC5345_250X395.jpg")} alt="Learn about Kevin Effertz at kevineffertz.com"  className="img-fluid rounded border border-dark"/>
                    </div>
                    ...
                    <div className="tab-content">
                        <div id="experience" className="container tab-pane active">
                            <div className="experience-Grid">
                                <div className="card">
                                    <span className="bg-lightskyblue"> <img className="card-img-top" src={require("./assets/images/DigitalTransformation-Web.png")} alt="Digital Transformation photo"/> </span>
                                ...
                                <div className="card">
                                    <span className="bg-warning"><img className="card-img-top" src={require("./assets/images/IT Support.png")} alt="IT Support.png"/></span>
                                    <div className="card-body">
                                ...
                                <div className="card">
                                    <span className="border-bottom"><img className="card-img-top" src={require("./assets/images/WI-statute-TOC.png")} alt="WI Statutory TOC"/></span>
                                    <div className="card-body">
                                ...
                                <div className="card">
                                    <span className="bg-lightyellow"><img className="card-img-top" src={require("./assets/images/ExtractTransformLoad.png")} alt="ExtractTransformLoad.png"/></span>
                                    <div className="card-body">
                        ...
                        <div id="education" className="container tab-pane fade">
                            <div className="education-Grid">
                                <div className="card card-body">
                                    ...
                                    <img className="card-img-top" src={require("./assets/images/UW-Stout_20190622_152336.jpg")} alt="UW-Stout Campus photo"/></div>
                                <div className="card card-body">
                                    ...
                                    <p className="card-text">University of St. Thomas<br/>
                                        St. Paul, MN 55105</p>
                                    <img className="card-img-top" src={require("./assets/images/University-of-StThomas_DSC5602.JPG")} alt="St. Thomas University Campus photo"/> </div>
                            </div>
                        </div>
                    </div>
                </div>
...
{/*            <!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
            ...
            <script>
                // let typewriterText = document.getElementById('typewriterText').innerText;
            ...
            <script type="text/javascript">
                ...
                $('a[href^="#"][href!="#experience"][href!="#education"][href!="#service"]').on('click',function (e) {e.preventDefault();
                ...
                <div className="modal-dialog modal-lg">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <div className="rounded bg-lightskyblue mb-3"> <img className="img-fluid" src={require("./assets/images/DigitalTransformation-Web.png")} alt="DigitalTransformation-Web.png"/></div>
            ...
            <div className="modal" id="customerServiceModal">
                <div className="modal-dialog modal-lg">
                    <div className="modal-content">
                        ...
                        {/*<!-- Modal body -->*/}
                        <div className="modal-body">
                            <div className="border rounded bg-warning mb-3"> <img className="img-fluid" src={require("./assets/images/IT Support.png")} alt="IT Support.png"/></div>
            ...
            <div className="modal" id="contentDatabaseManagementModal">
                <div className="modal-dialog modal-lg">
                    <div className="modal-content">
                        ...
                        {/*<!-- Modal body -->*/}
                        <div className="modal-body">
                            <div className="border rounded border-dark mb-3"> <img className="img-fluid" src={require("./assets/images/WI-statute-TOC.png")} alt="IT Support.png"/></div>
            ...
            <div className="modal" id="ETLModal">
                <div className="modal-dialog modal-lg">
                    <div className="modal-content">
                        ...
                        {/*<!-- Modal body -->*/}
                        <div className="modal-body">
                            <div className="border rounded mb-3 border-dark" style={{borderWidth:"3px !important"}}> <img className="img-fluid" src={require("./assets/images/ExtractTransformLoad.png")} alt="ExtractTransformLoad.png"/></div>
